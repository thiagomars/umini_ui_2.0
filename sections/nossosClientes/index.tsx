...
export default function NossosClientes() {
    ...
    return (
        <section id="nossosClientes">
            <Section>
                <div className="grid lg:grid-cols-2 gap-10 p-20 items-center">
                    <div className="flex flex-col gap-8 w-5/6">
                        ...
                        <BoxView delay={400}>
                            <p className="text-justify">
                                Com atuação em todo o Brasil, entregamos projetos de <span className="font-bold">baixa e média tensão, subestações,
